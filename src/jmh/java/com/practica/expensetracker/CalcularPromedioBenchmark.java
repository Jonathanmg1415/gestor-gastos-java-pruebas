...
/**
 * calcularPromedio() llama internamente a calcularTotal() y luego divide,
 * asi que se espera un costo muy cercano al de CalcularTotalBenchmark mas
 * el overhead extra de la division de BigDecimal.
 */
@BenchmarkMode(Mode.AverageTime)
@OutputTimeUnit(TimeUnit.MICROSECONDS)
@State(Scope.Benchmark)
public class CalcularPromedioBenchmark {
    ...
    public BigDecimal calcularPromedio() {
        return servicioReporte.calcularPromedio();
    }
}
